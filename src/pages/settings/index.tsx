        ...
        <section className="glass p-8 rounded-[2.5rem] border-white/10 bg-white/[0.02] space-y-8">
          ...
          <div className="pt-8 border-t border-white/5 space-y-6">
            ...
            <form action="/settings/manual" method="POST" className="flex gap-3">
              ...
              />
              <button type="submit" className="px-6 py-3 bg-zinc-800 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-zinc-700 transition-all border border-white/10">
                Update ID
              </button>
            </form>
          </div>
