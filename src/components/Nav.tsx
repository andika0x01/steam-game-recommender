          ...
          ">
            {!steamId ? (
              <>
                ...
                <a href="/auth/login" className="px-10 md:px-5 py-5 md:py-2.5 bg-white text-black text-sm md:text-xs font-black uppercase tracking-[0.2em] rounded-2xl md:rounded-xl hover:bg-zinc-200 transition-all">
                  Login
                </a>
              </>
            ) : (
