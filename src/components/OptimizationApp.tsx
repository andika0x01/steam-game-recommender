...
export const OptimizationApp = ({ defaultBudget }: OptimizationAppProps) => {
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start justify-between">
        <div className="space-y-4 max-w-xl">
          ...
          <p className="text-zinc-500 text-sm md:text-base leading-relaxed">
            Sistem telah berhasil menyusun kombinasi game optimal dari katalog Steam Indonesia menggunakan budget Rp{targetBudgetNum.toLocaleString("id-ID")}.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-4">
              ...
              <div className="glass p-6 rounded-3xl border-orange-500/10 bg-orange-500/[0.02] space-y-4">
                ...
                <p className="text-[11px] text-zinc-500 leading-relaxed italic border-l-2 border-orange-500/30 pl-4">
                  Sistem memulai dengan mengurutkan kandidat berdasarkan densitas skor. Fungsi Energi (E) dihitung untuk memaksimalkan total relevansi sekaligus memberikan penalti
                  berat bagi sisa budget yang tidak terpakai.
                </p>
              </div>
            </div>
              ...
              <div className="p-6 space-y-3">
                ...
                <ul className="space-y-2 text-[10px] font-bold text-zinc-400 uppercase tracking-tight">
                  <li className="flex items-center gap-2">
                    <div className="w-1 h-1 bg-orange-500 rounded-full" /> TAMBAH: Memasukkan game baru jika budget tersedia.
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1 h-1 bg-orange-500 rounded-full" /> HAPUS: Mengeluarkan game secara acak (eksplorasi).
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1 h-1 bg-orange-500 rounded-full" /> GANTI: Menukar game terpilih dengan kandidat lain.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <div className="glass p-6 rounded-3xl border-orange-500/10 bg-orange-500/[0.02] space-y-4">
                <div className="text-zinc-300">{`\\[ P(\\text{accept}) = \\begin{cases} 1 & \\Delta E > 0 \\\\ e^{\\frac{\\Delta E}{T}} & \\Delta E \\leq 0 \\end{cases} \\]`}</div>
                <p className="text-[11px] text-zinc-500 leading-relaxed italic border-l-2 border-orange-500/30 pl-4">
                  Kombinasi yang lebih baik selalu diterima. Namun, kombinasi yang lebih buruk terkadang diterima dengan probabilitas P untuk mencegah sistem terjebak dalam solusi
                  lokal yang tidak optimal.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="glass p-6 rounded-3xl border-white/5 bg-white/[0.01] space-y-4">
                ...
                <p className="text-[11px] text-zinc-500 leading-relaxed">
                  Algoritma berhenti mencari ketika suhu mencapai titik beku (T &lt; 40) atau mencapai batas iterasi maksimum (400 kali). Parameter ini menjaga keseimbangan antara
                  kualitas solusi dan efisiensi waktu proses.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="w-full">
      ...
      {isOptimizing && (
        <SAAnimationOverlay budget={targetBudgetNum} candidates={candidates} animationSteps={animationSteps} totalIterations={totalIterations || 0} onFinish={handleFinish} />
      )}
